...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        createExports: (instance) => {
            ...
            const exports = {
                adhikaar_verify_bundle: function bjs_adhikaar_verify_bundle(json) {
                    const jsonBytes = textEncoder.encode(json);
                    const jsonId = swift.memory.retain(jsonBytes);
                    instance.exports.bjs_adhikaar_verify_bundle(jsonId, jsonBytes.length);
                    const ret = tmpRetString;
                    tmpRetString = undefined;
                    return ret;
                },
                adhikaar_normalize_challenge: function bjs_adhikaar_normalize_challenge(value) {
                    const valueBytes = textEncoder.encode(value);
                    const valueId = swift.memory.retain(valueBytes);
                    instance.exports.bjs_adhikaar_normalize_challenge(valueId, valueBytes.length);
                    const ret = tmpRetString;
                    tmpRetString = undefined;
                    return ret;
                },
                adhikaar_engine_version: function bjs_adhikaar_engine_version() {
                    instance.exports.bjs_adhikaar_engine_version();
                    const ret = tmpRetString;
                    tmpRetString = undefined;
                    return ret;
                },
