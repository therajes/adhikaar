...
function shell(content: string): string {
  ...
  return `<header class="site-header"><a class="brand" href="/" data-link aria-label="ADHIKAAR home"><span class="brand-mark"><i data-lucide="shield-check"></i></span><span>ADHIKAAR<small>Authority you can verify</small></span></a>
